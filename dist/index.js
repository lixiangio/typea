...
class Parser {
    ...
    expression(key, express, data) {
        ...
        const methods = types.get(express.type);
        if (methods) {
 ...
 */
function validator(mode, schema, originData, extend) {
 ...
 * @param options 扩展方法
 */
typea.type = function (type, options) {
